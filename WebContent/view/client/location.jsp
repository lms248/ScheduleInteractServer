	...
	<script src="/rcgl/js/client/location.js"></script>
	
<div class="hero-unit" style="width: 2000px;" >
	<div class="page-header">
  		<h6 class="title-font">定位 <small style="title-font">管理</small></h6>
	</div>
  	<table>
  	<tr>
  	<td>
	<div id="search">
		<input id="location_search" type="text" size="25" value="" style="height: 30px;margin-top: 10px;"  placeholder="请输入用户ID查询…"  />
  	 	<input type="submit" class="btn" onclick="getLocationDB(1,1)" style="cursor: pointer;" value="查询定位" name="search" />
	</div>
	</td>
  	<td>
	<div class="black"> 
    	...
    	<!-- <input type="button" value="刷新数据" onclick="getLocationDB(1,0)" > -->
	</div>
	</td>
	</tr>
	</table>	
	<div id="locationdb" style="height: 650px;"></div>
	
</div>


<div id="locationShow" class="modal fade" style="background-color: inherit;border: 0px solid rgba(0, 0, 0, 0.3); box-shadow: 0px 0px 0px 0px;width: 600px;">
  <div class="modal-dialog" id="locationShow">
