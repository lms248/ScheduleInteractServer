	...
	<script src="/rcgl/js/client/message.js"></script>

<div class="hero-unit" style="width: 2000px;" >
	<div class="page-header">
  		<h6 class="title-font">消息 <small style="title-font">管理</small></h6>
	</div>	
  	<table>
  	<tr>
  	<td>
	<div id="search">
		<input id="message_search" type="text" size="25" value="" style="height: 30px;margin-top: 10px;"  placeholder="请输入接收者ID查询…"  />
  	 	<input type="submit" class="btn" onclick="getMessageDB(1,1)" style="cursor: pointer;" value="查询消息" name="search" />
	</div>
	</td>
  	<td>
	<div class="black"> 
    	...
    	<!-- <input type="button" value="刷新数据" onclick="getMessageDB(1,0)" > -->
	</div>
	</td>
	</tr>
	</table>	
	<div id="messagedb" style="height: 650px;"></div>
	
</div>


<div id="messageShow" class="modal fade" style="background-color: inherit;border: 0px solid rgba(0, 0, 0, 0.3); box-shadow: 0px 0px 0px 0px;width: 600px;">
  <div class="modal-dialog" id="messageShow">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <table class="table table-bordered table-hover">
		  <tr>
		    <td><span id="messageInfo"></span></td>
		  </tr>
		</table>
      </div>
    </div>
