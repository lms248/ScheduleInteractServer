	...
	<script src="/rcgl/js/client/user.js"></script>
	
<div class="hero-unit" style="width: 2000px;" >
	<div class="page-header">
  		<h6 class="title-font">用户<small style="title-font">管理</small></h6>
	</div>
  	<table>
  	<tr>
  	<td>
	<div id="search">
		<input id="username_search" type="text" size="25" value="" style="height: 30px;margin-top: 10px;"  placeholder="请输入用户名查询…"  />
  	 	<input type="submit" class="btn" onclick="getUserDB(1,1)" style="cursor: pointer;" value="查询用户" name="search" />
	</div>
	</td>
  	<td>
	<div class="black"> 
    	...
    	<!-- <input type="button" value="刷新数据" onclick="getUserDB(1,0)" > -->
	</div>
	</td>
	</tr>
	</table>	
	<div id="userdb" style="height: 650px;"></div>
	
</div>


<div id="userShow" class="modal fade" style="background-color: inherit;border: 0px solid rgba(0, 0, 0, 0.3); box-shadow: 0px 0px 0px 0px;width: 600px;">
  <div class="modal-dialog" id="userShow">
