	...
	<script src="/rcgl/js/client/activities.js"></script>
	
<div class="hero-unit" style="width: 2000px;" >
	<div class="page-header">
  		<h6 class="title-font">活动 <small style="title-font">管理</small></h6>
	</div>
  	<table>
  	<tr>
  	<td>
	<div id="search">
		<input id="activities_search" type="text" size="25" value="" style="height: 30px;margin-top: 10px;"  placeholder="请输入活动内容查询…"  />
  	 	<input type="submit" class="btn" onclick="getActivitiesDB(1,1)" style="cursor: pointer;" value="查询活动" name="search" />
	</div>
	</td>
  	<td>
	<div class="black"> 
    	...
    	<!-- <input type="button" value="刷新数据" onclick="getActivitiesDB(1,0)" > -->
	</div>
	</td>
	</tr>
	</table>	
	<div id="activitiesdb" style="height: 650px;"></div>
	
</div>


<div id="activitiesShow" class="modal fade" style="background-color: inherit;border: 0px solid rgba(0, 0, 0, 0.3); box-shadow: 0px 0px 0px 0px;width: 600px;">
  <div class="modal-dialog" id="activitiesShow">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <table class="table table-bordered table-hover">
		  <tr>
		    <td><span id="activitiesInfo"></span></td>
		  </tr>
		</table>
      </div>
    </div>
